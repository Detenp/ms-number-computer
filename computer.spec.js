    ...
    describe('"add" function', () => {
        ...
        describe('Error', () => {
            ...
            it('should throw error if the first argument is a String', () => {
                expect(computer.add.bind(computer, "40", 2)).to.throw('string is not a valid number [arg 0].');
            });

            it('should throw error if the second argument is a String', () => {
                expect(computer.add.bind(computer, 40, "2")).to.throw('string is not a valid number [arg 1].');
            });
        });
